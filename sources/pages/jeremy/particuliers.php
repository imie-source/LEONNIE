...
<html>
	...
	<body>
		...
		<div>
			...
			1.pièce avant (ancient meuble)</br>
			2.proposition avec échantillons</br>
			3.meuble fini en situation</p>
		</div>
		
		<!-- Intégration du bandeau de gauche -->
		<div>
			<p><a href="particuliers.php">Particuliers</a></br>
			<a href="professionnels.php">Professionnels</a></br>
			<a href="cours.php">Cours</a></br>
		</div>
