...
(function() {
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            arrayCompare:function(b, a) {
                ...
                for(var b=[].concat(b),a,d=[],h=0;h<b.length
                ;h++
                )if(a = b[h]
    ...
    (function() {
        ...
        function f(a, b, c) {
            var d = a.name;
            if (t.$empty[d] || !a.children.length)if (d == "hr" && b == "br")
                a.replaceWith(s());
            else {
                ...
                if (a(f))
                    ...
                    if (d == "br")
                        ...
                        for (;;) {
                            ...
                            if (!f.isUnknown && !m.isUnknown && !g[d])if (m.isOptionalClose)
                                u.onTagClose(h);
    ...
    (function() {
        ...
        var y = /(?:&nbsp;|\xa0)$/, m = "{cke_protected}", k = CKEDITOR.dtd, l = [
            "caption","colgroup","col","thead","tfoot",
            "tbody"
        ], t = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block), x = {elements:{input:n,textarea:n}}, r = {attributeNames:[[/^on/,"data-cke-pa-on"],[/^data-cke-expando$/,""]]}, L = {elements:{embed:function(a) {
            var b = a.parent;
            if (b && b.name == "object") {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
                                                                                                        type:CKEDITOR.NODE_ELEMENT,add:b.add,clone:function() {
                                                                                                            ...
                                                                                                            for (i in g) {
                                                                                                                j = i;
                                                                                                                for (n=g[i];;)
                                                                                                                    if (j=a.onAttributeName(b, i))if (j != i) {
                                                                                                                        delete g[i];
                                                                                                                        i = j
                                                                                                                    }else
                                                                                                                        break;
    ...
    (function() {
        ...
        var r = {address:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1,section:1,header:1,footer:1,nav:1,article:1,aside:1,figure:1,dialog:1,hgroup:1,time:1,meter:1,menu:1,command:1,keygen:1,output:1,progress:1,details:1,datagrid:1,datalist:1}, L = {
            a:1,
                                             ...
                                             CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {
                                                                                                                                                     getInputElement:function() {
                                                                                                                                                         ...
                                                                                                                                                         function b() {
                                                                                                                                                             ...
                                                                                                                                                             d.$.write([
                                                                                                                                                                 '<html dir="' + g + '" lang="' + k + '"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">','<form enctype="multipart/form-data" method="POST" dir="' + g + '" lang="' + k + '" action="',CKEDITOR.tools.htmlEncode(e.action),'"><label id="',a.labelId,'" for="',i,'" style="display:none">',CKEDITOR.tools.htmlEncode(e.label),'</label><input id="',i,'" aria-labelledby="',a.labelId,'" type="file" name="',CKEDITOR.tools.htmlEncode(e.id || "cke_upload"),'" size="',CKEDITOR.tools.htmlEncode(0 <
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    b?b:""),'" /></form></body></html><script>',CKEDITOR.env.ie?"(" + CKEDITOR.tools.fixDomain + ")();":"","window.parent.CKEDITOR.tools.callFunction(" + f + ");","window.onbeforeunload = function() {window.parent.CKEDITOR.tools.callFunction(" + h + ")}","<\/script>"
                                                                                                                                                             ].join(""));
                                                                                                                                                             d.$.close();
                                                                                                                                                             for (b=0;b < c.length;b++)
                                                                                                                                                                 c[b].enable()
            ...
            setupContent:function() {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml([
                        '<a class="cke_dialog_tab"',0 < this._.pageCount?" cke_last":"cke_first",c,a.hidden?
                    ...
                    if (j && h) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            ...
                            if (d.is("li"))if (i || m)
                                ...
                                if (e)if (d=f.createElement(c == CKEDITOR.ENTER_P?"p":"div"),l && d.setAttribute("dir", j),n && d.setAttribute("style", n),h && d.setAttribute("class", h),a.moveChildren(d),i || m)
                                    d[i?
    ...
    (function() {
        ...
        x.prototype = {
            exec:function(c) {
                ...
                for (n=[];0 < j.length;)
                    if (d=j.shift(),this.state == CKEDITOR.TRISTATE_OFF)if (r[d.root.getName()]) {
                        b = c;
                        f = d;
                        d = h;
                        g = n;
